  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <header className="relative sticky top-0 z-50 isolate overflow-visible bg-[#2563eb]/95 px-4 pb-4 pt-[max(1.25rem,env(safe-area-inset-top))] text-center shadow-md">
